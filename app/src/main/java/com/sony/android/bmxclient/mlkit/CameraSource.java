...
public class CameraSource {
  ...
  private final VisionImageProcessor.Listener visionListener;
  ...
  public CameraSource(Activity activity, GraphicOverlay overlay, VisionImageProcessor.Listener listener) {
